/*
  ...
  - You are about to drop the `Exrecise` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_ExreciseToWorkout` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "_ExreciseToWorkout" DROP CONSTRAINT "_ExreciseToWorkout_A_fkey";

-- DropForeignKey
ALTER TABLE "_ExreciseToWorkout" DROP CONSTRAINT "_ExreciseToWorkout_B_fkey";

-- DropTable
DROP TABLE "Exrecise";

-- DropTable
DROP TABLE "_ExreciseToWorkout";
